      ...
      if (!isManager && !isCEO && !isHC) {
        ...
        if (findByText('Well-being Check-in')) {
          steps.push({ targetSelector: 'wellbeing', icon: 'ti-heart',
            ...
            body: `Your AI companion checks in with a short question about how you're feeling. Your responses stay private and help you track your own well-being over time. Only shown when HC enables this feature.` });
        }
        ...
        if (findByText('Initiatives') || document.querySelector('button[onclick*="empShowInitiativeForm"]')) {
          steps.push({ targetSelector: 'initiatives', icon: 'ti-bulb',
            ...
            body: `Have an idea to improve KABi, or completed a course/certification? Submit it as an initiative — academic or general. Your manager reviews first, then HC gives final approval. Approved initiatives count toward your evaluation.` });
        }
      ...
      if (isHC) {
        return [
          ...
          { targetSelector: `.dash-box[onclick*="hcOpenSection('pe')"]`, icon: 'ti-clipboard-list',
            ...
            body: `Configure evaluation cycles, weights, scoring logic, and frequency. Review manager progress and edit-request approvals. This is where you set up how evaluations run — but managers do the actual scoring.` },
          { targetSelector: `.dash-box[onclick*="hcOpenSection('kpi')"]`, icon: 'ti-target',
            title: 'KPI Framework',
            body: `Review KPI submissions from managers, approve or reject them. Manage the curated 173-KPI library across all functions. Also where you manage users and their access permissions.` },
          ...
          { targetSelector: null, icon: 'ti-trophy', title: 'Release Results',
          ...
          { targetSelector: null, icon: 'ti-confetti', title: `You're all set!`,
            body: `You've seen your HC Admin toolkit. Welcome to your command center.` }
        ];
      }
