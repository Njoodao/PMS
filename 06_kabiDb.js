...
(function () {
  ...
  const kabiDb = {
    ...
    _getTourSteps() {
      ...
      // Lookup employee from window.PE_EMPLOYEES for name/role if we only have email
      let peLookup = null;
      if (effectiveEmail && Array.isArray(window.PE_EMPLOYEES)) {
        peLookup = window.PE_EMPLOYEES.find(e => e.email?.toLowerCase() === effectiveEmail.toLowerCase());
      }
      ...
      if (!isManager && !isCEO && !isHC) {
        return [
          ...
          { tabKey: null, icon: 'ti-user', title: 'Your Profile Card',
          ...
          { tabKey: null, icon: 'ti-target', title: 'My Performance KPIs',
          ...
          { tabKey: null, icon: 'ti-bulb', title: 'Submit Initiatives',
          ...
          { tabKey: null, icon: 'ti-brain', title: 'INVIEWS Self-Assessment',
          ...
          { tabKey: null, icon: 'ti-bell', title: 'Notifications',
      ...
      if (isHC) {
        return [
          ...
          { tabKey: null, icon: 'ti-target', title: 'HC Performance Hub',
          ...
          { tabKey: null, icon: 'ti-trending-up', title: 'All Submissions',
          ...
          { tabKey: null, icon: 'ti-bulb', title: 'Initiative Approvals',
          ...
          { tabKey: null, icon: 'ti-settings', title: 'Settings & Configuration',
          ...
          { tabKey: null, icon: 'ti-bell', title: 'Notifications & Audit',
      ...
      return [
        ...
        { tabKey: null, icon: 'ti-chart-bar', title: 'Executive Dashboard',
        ...
        { tabKey: null, icon: 'ti-users', title: 'Full Organization View',
        ...
        { tabKey: null, icon: 'ti-trending-up', title: 'Trends & Patterns',
  ...
  console.info('[KABi] Universal tour watcher active');
})();
