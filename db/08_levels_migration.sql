...
-- The employees table uses a boolean `is_fte` (there is NO employment_type column).
-- (Abdulaziz Aloraij = IT Advisor contract; Manal Qatab = contractor.)
UPDATE employees SET is_fte = false
...
SELECT email, org_level, is_fte FROM employees
